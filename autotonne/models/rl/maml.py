...
from ray.rllib.agents.maml import MAMLTrainer
...
@ModelFactory.register('rl-maml')
class MAMLContainer(object):
    def __init__(self, **kwargs):
        super().__init__()
        self.estimator = MAMLrl(**kwargs)
...
class MAMLrl(object):
    def __init__(self, env, env_config, config):
        ...
        self.agent = MAMLTrainer(config = self.config, env = env)
